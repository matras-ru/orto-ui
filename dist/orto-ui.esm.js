...
import tailwindcssTransitions from 'tailwindcss-transitions';
import tailwindcssTransforms from 'tailwindcss-transforms';
...
var CIcon = { baseClass: baseClass$1, defaultClass: defaultClass$1, defaultSizeClass: defaultSizeClass$1, largeSizeClass: largeSizeClass$1, smallSizeClass: smallSizeClass$1 };
...
var DefaultTheme = /*#__PURE__*/Object.freeze({
    ...
    CRadioCheckbox: CRadioCheckbox,
    CTabs: CTabs,
    CTab: CTab,
    CList: ThemeClass,
    CListItem: CListItem,
    CContainer: ThemeClass$1,
    CRow: CRow,
    CCol: CCol
});
...
var components = /*#__PURE__*/Object.freeze({
    __proto__: null,
    CForm: form,
    CFormError: formError,
    CFormGroup: formGroup,
    CFormInput: formInput,
    CFormLabel: formLabel,
    CRadio: radio,
    CRadioGroup: radioGroup,
    CCheckbox: checkbox,
    CCheckboxGroup: checkboxGroup,
    CButton: button,
    CTabs: tabs,
    CTab: tab,
    CTabPanels: tabPanels,
    CTabPanel: tabPanel,
    CList: list,
    CListItem: listItem,
