module.exports = {
    ...
    variants: {
        ...
        backgroundOpacity: ['responsive', 'hover', 'disabled'],
        ...
        scale: ['responsive', 'hover', 'disabled'],
        rotate: ['responsive', 'hover', 'disabled'],
        translate: ['responsive', 'hover', 'disabled'],
        skew: ['responsive', 'hover', 'disabled'],
